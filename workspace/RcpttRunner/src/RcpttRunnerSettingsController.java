...
public class RcpttRunnerSettingsController implements Initializable{
	...
	@FXML
	private ComboBox<String> commonMobileCombo;
	
	@FXML
	private ComboBox<String> commonWearableCombo;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		ObservableList<String> optionsCommonMobileMode =
			    FXCollections.observableArrayList(
			        "3.0",
			        "2.4"
		);
		commonMobileCombo.setItems(optionsCommonMobileMode);
		commonMobileCombo.getSelectionModel().select("2.4");
		
		ObservableList<String> optionsCommomWearableMode =
			    FXCollections.observableArrayList(
			        "3.0",
			        "2.3.1"
		);
		commonWearableCombo.setItems(optionsCommomWearableMode);
		commonWearableCombo.getSelectionModel().select("2.3.1");
