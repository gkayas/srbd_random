...
public class Target
{
	...
	public Target() {
		try {
//			Registry reg = LocateRegistry.getRegistry(Integer.valueOf(CommonUtils.rmiPort));
			obj = (Stub)Naming.lookup("//localhost/"+CommonUtils.rmiPort);
	...
	{
//		try {
//			Point devicePoint = obj.getDeviceRegion();
