...
public class ImagePanel extends JPanel {
	...
	public ImagePanel(String imgPath) {
		if(imgPath != null) {
			...
			label = new JLabel("No Image Selected", JLabel.CENTER);
...
//		    add(Box.createRigidArea(new Dimension(2, 2)), new Float(1));
		    add(label);
//		    add(Box.createRigidArea(new Dimension(2, 2)), new Float(1));
		    add(Box.createGlue(), new Float(1));
		}
...
class RelativeLayout implements LayoutManager2, java.io.Serializable
{
	 ...
	 *
	 */
	private static final long serialVersionUID = -8142774749943952709L;
