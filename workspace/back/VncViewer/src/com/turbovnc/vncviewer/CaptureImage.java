...
public class CaptureImage extends Thread {
	...
	public void run() {
		...
		capturePrompt.setBounds(codeGenerator.cc.viewport.getX(), codeGenerator.cc.viewport.getY()+86, codeGenerator.cc.viewport.getWidth(), codeGenerator.cc.viewport.getHeight()-126);
