    	   ...
    	   cc.viewport.getCodeGenerator().getCodeBox().isTapOnTextSelected()) {
	    	if(!cc.viewport.getCodeGenerator().isCodeRunning()) {
	    		...
	    		if(distance == 0) {
	    	    	...
	    	    	cc.viewport.getCodeGenerator().swipeOnScreen(dragStartX, dragStartY, lastX, lastY);
	    		}
	    	}
    	}
    }
