...
struct tizen_gesture_listener {
	/**
	 * grab_swipe_notify - (none)
	 * @num_of_fingers: (none)
	 * @direction: (none)
	 * @error: (none)
	 */
	void (*grab_swipe_notify)(void *data,
...
#define TIZEN_GESTURE_GRAB_SWIPE	0
#define TIZEN_GESTURE_UNGRAB_SWIPE	1

#define TIZEN_GESTURE_GRAB_SWIPE_SINCE_VERSION	1
#define TIZEN_GESTURE_UNGRAB_SWIPE_SINCE_VERSION	1
...
static inline void
tizen_gesture_grab_swipe(struct tizen_gesture *tizen_gesture, uint32_t num_of_fingers, uint32_t direction)
{
	wl_proxy_marshal((struct wl_proxy *) tizen_gesture,
			 TIZEN_GESTURE_GRAB_SWIPE, num_of_fingers, direction);
}

static inline void
tizen_gesture_ungrab_swipe(struct tizen_gesture *tizen_gesture, uint32_t num_of_fingers, uint32_t direction)
{
	wl_proxy_marshal((struct wl_proxy *) tizen_gesture,
			 TIZEN_GESTURE_UNGRAB_SWIPE, num_of_fingers, direction);
}
...
tizen_video_get_viewport(struct tizen_video *tizen_video, struct wl_subsurface *subsurface)
{
	struct wl_proxy *id;

	id = wl_proxy_marshal_constructor((struct wl_proxy *) tizen_video,
			 TIZEN_VIDEO_GET_VIEWPORT, &tizen_viewport_interface, NULL, subsurface);
