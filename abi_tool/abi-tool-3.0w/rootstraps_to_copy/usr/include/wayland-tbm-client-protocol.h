...
#define WL_TBM_REQUEST_TBM_MONITOR	2
#define WL_TBM_CREATE_SURFACE_QUEUE	3

#define WL_TBM_CREATE_BUFFER_SINCE_VERSION	1
#define WL_TBM_CREATE_BUFFER_WITH_FD_SINCE_VERSION	1
#define WL_TBM_REQUEST_TBM_MONITOR_SINCE_VERSION	1
...
struct wl_tbm_queue_listener {
	 ...
	 * @buf2: (none)
	 */
	void (*buffer_attached_with_id)(void *data,
					struct wl_tbm_queue *wl_tbm_queue,
					struct wl_buffer *id,
					int32_t width,
					int32_t height,
	 ...
	 * @buf2: (none)
	 */
	void (*buffer_attached_with_fd)(void *data,
					struct wl_tbm_queue *wl_tbm_queue,
					struct wl_buffer *id,
					int32_t width,
					int32_t height,
