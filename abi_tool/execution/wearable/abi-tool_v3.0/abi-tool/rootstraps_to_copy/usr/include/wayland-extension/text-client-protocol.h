 ...
 * @WL_TEXT_INPUT_CONTENT_PURPOSE_VOICE: input for a voice
 *
...
enum wl_text_input_content_purpose {
	...
	WL_TEXT_INPUT_CONTENT_PURPOSE_VOICE = 21,
};
...
#ifndef WL_TEXT_INPUT_CAPITAL_MODE_ENUM
#define WL_TEXT_INPUT_CAPITAL_MODE_ENUM
/**
 * wl_text_input_capital_mode - capital mode
 * @WL_TEXT_INPUT_CAPITAL_MODE_UPPERCASE: uppercase
 * @WL_TEXT_INPUT_CAPITAL_MODE_LOWERCASE: lowercase
 *
 * This allows to specify capital mode on the input panel.
 */
enum wl_text_input_capital_mode {
	WL_TEXT_INPUT_CAPITAL_MODE_UPPERCASE = 0,
	WL_TEXT_INPUT_CAPITAL_MODE_LOWERCASE = 1,
};
#endif /* WL_TEXT_INPUT_CAPITAL_MODE_ENUM */
 ...
 * @hide_permission: permission to hide input panel
 *
...
struct wl_text_input_listener {
	 ...
	 */
	void (*hide_permission)(void *data,
				struct wl_text_input *wl_text_input,
				uint32_t response);
};
...
#define WL_TEXT_INPUT_DESTROY	0
#define WL_TEXT_INPUT_ACTIVATE	1
#define WL_TEXT_INPUT_DEACTIVATE	2
#define WL_TEXT_INPUT_SHOW_INPUT_PANEL	3
#define WL_TEXT_INPUT_HIDE_INPUT_PANEL	4
#define WL_TEXT_INPUT_RESET	5
...
#define WL_TEXT_INPUT_SET_RETURN_KEY_DISABLED	12
#define WL_TEXT_INPUT_SET_INPUT_PANEL_DATA	13
#define WL_TEXT_INPUT_BIDI_DIRECTION	14
#define WL_TEXT_INPUT_SET_CURSOR_POSITION	15
#define WL_TEXT_INPUT_PROCESS_INPUT_DEVICE_EVENT	16
#define WL_TEXT_INPUT_FILTER_KEY_EVENT	17
#define WL_TEXT_INPUT_GET_HIDE_PERMISSION	18
#define WL_TEXT_INPUT_SET_CAPITAL_MODE	19

#define WL_TEXT_INPUT_DESTROY_SINCE_VERSION	1
...
#define WL_TEXT_INPUT_GET_HIDE_PERMISSION_SINCE_VERSION	1
#define WL_TEXT_INPUT_SET_CAPITAL_MODE_SINCE_VERSION	1
...
static inline void
wl_text_input_filter_key_event(struct wl_text_input *wl_text_input, uint32_t serial, uint32_t time, const char *keyname, uint32_t state, uint32_t modifiers, const char *dev_name, uint32_t dev_class, uint32_t dev_subclass)
{
	wl_proxy_marshal((struct wl_proxy *) wl_text_input,
			 WL_TEXT_INPUT_FILTER_KEY_EVENT, serial, time, keyname, state, modifiers, dev_name, dev_class, dev_subclass);
}

static inline void
wl_text_input_get_hide_permission(struct wl_text_input *wl_text_input)
{
	wl_proxy_marshal((struct wl_proxy *) wl_text_input,
			 WL_TEXT_INPUT_GET_HIDE_PERMISSION);
}

static inline void
wl_text_input_set_capital_mode(struct wl_text_input *wl_text_input, uint32_t mode)
{
	wl_proxy_marshal((struct wl_proxy *) wl_text_input,
			 WL_TEXT_INPUT_SET_CAPITAL_MODE, mode);
}
