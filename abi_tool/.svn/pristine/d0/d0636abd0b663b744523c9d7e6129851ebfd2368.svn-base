...
//		String index = baseUrl+"/index.html";
		try {
			...
			Scanner sc = new Scanner(new File("packages.list"));
			while (sc.hasNextLine()) {
				String line = sc.nextLine().trim();
				if(line.length() == 0) continue;
				urlList.add(baseUrl+"/"+line+"/"+version+"/compat_report.html");
			}
			
			sc.close();
			
//			urlList.add(baseUrl+"/"+"chromium-efl"+"/2.4_to_3.0/compat_report.html");
//			urlList.add(baseUrl+"/"+"data-control"+"/2.4_to_3.0/compat_report.html");
//			urlList.add(baseUrl+"/"+"evas"+"/2.4_to_3.0/compat_report.html");
//			urlList.add(baseUrl+"/"+"message-port"+"/2.4_to_3.0/compat_report.html");
//			urlList.add(baseUrl+"/"+"service-adaptor"+"/2.4_to_3.0/compat_report.html");
//			urlList.add(baseUrl+"/"+"data-control"+"/2.3.1_to_3.0/compat_report.html");
//			urlList.add(baseUrl+"/"+"message-port"+"/2.3.1_to_3.0/compat_report.html");
//			urlList.add(baseUrl+"/"+"chromium-efl"+"/2.3.1_to_3.0/compat_report.html");
	...
	static void parseUrl(String filename){
		try{
			...
			System.out.println("***********"+packageName+"***********"+filename);
		 	...
		 	Label c2 = new Label(2, packageNumber, packageName);
